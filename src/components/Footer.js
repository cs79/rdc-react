        ...
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            <Modal trigger={<Menu.Item>About</Menu.Item>}>
                ...
                <Modal.Description>
                    ...
                    <p>randomcoin (RDC) is an ERC20 token with a random exchange rate to ether. Its value will be randomly determined on every transaction into or out of the token, and can be used as a cryptocurrency portfolio hedge or for speculation.</p>
                    ...
                    <p>In the even that the contract is in the Liquidating state, you may instead claim ETH from the contract proportional to any RDC holdings should you wish to do so.</p>
